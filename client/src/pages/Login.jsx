    ...
    <div className="max-w-md w-full mx-auto my-20 rounded-2xl md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
          New to <span className="bg-gradient-to-r from-cyan-500 to-indigo-500 text-transparent bg-clip-text font-extrabold">Alpha-Bot</span>? <Link to="/signup" className="hover:text-cyan-500">Signup.</Link>
        </p>
